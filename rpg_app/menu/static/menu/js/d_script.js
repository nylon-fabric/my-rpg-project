...
var bentImg = new Array('../../static/menu/js/media/main.png', 
  ...
  setTimeout(function(){img.src = goImg[2]}, speed1);
  setTimeout(function(){img.src = goImg[3]}, speed2);
  setTimeout(function(){img.src = goImg[4]}, speed3);
  setTimeout(function(){img.src = goImg[5]}, speed4);
  setTimeout(function(){img.src = goImg[6]}, speed5);
  setTimeout(function(){img.src = goImg[0]}, speed6);
